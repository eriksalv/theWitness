...
public class SaveGameController {
	...
	@FXML
	private DialogPane saveMessage;
	@FXML
	private Label closeSaveMessage;
	@FXML
	private Label returnToGameView;
	@FXML
	private Label returnToMainView;
	@FXML
	private Label header;
	@FXML
	private Label fileNotFoundMessage;
	@FXML
	private Button save;
	@FXML
	private Button load;
