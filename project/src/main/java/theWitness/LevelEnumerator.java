...
public enum LevelEnumerator implements LevelSettings, ISaveHandler {
	...
	@Override
	public Game startingTiles() throws FileNotFoundException, URISyntaxException { // gjør om gamecollection til ett
																					// game, siden det bare kan være 1
																					// level i hver level-fil.
		// this.name() refererer til navnet på enum konstanten som startingTiles() blir
		// kalt på. I config-mappen ligger det filer med samme navn + .level
